...
// Detectar se está rodando no Capacitor (app nativo Android/iOS)
const isCapacitorApp = (): boolean => {
  // Capacitor define window.Capacitor quando rodando em app nativo
  if ((window as any).Capacitor?.isNativePlatform?.()) {
    return true;
  }
  // Fallback: detectar pelo protocolo/hostname típico do Capacitor
  const href = window.location.href;
  if (href.includes('capacitor://') || 
